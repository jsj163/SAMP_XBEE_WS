...
set(MSG_I_FLAGS "-IXBee_command:/home/yunfei/Projects/SAMP_XBEE_WS/src/XBee_command/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/yunfei/Projects/SAMP_XBEE_WS/src/XBee_command/msg/Temperature.msg" NAME_WE)
add_custom_target(_XBee_command_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "XBee_command" "/home/yunfei/Projects/SAMP_XBEE_WS/src/XBee_command/msg/Temperature.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(XBee_command
  "/home/yunfei/Projects/SAMP_XBEE_WS/src/XBee_command/msg/Temperature.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/XBee_command)
  install(CODE "execute_process(COMMAND \"/home/yunfei/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/XBee_command\")")
  # install generated code
  install(
